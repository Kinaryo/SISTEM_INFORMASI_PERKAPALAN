                ...
                <form id="formEditKapal" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama_pemilik" id="nama_pemilik" class="form-control"
                            value="{{ old('nama_pemilik', $kapal->nama_pemilik) }}" placeholder="Masukkan nama pemilik"
                            required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nik" id="nik" class="form-control" value="{{ old('nik', $kapal->nik) }}"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="alamat" id="alamat" class="form-control" rows="3"
                            placeholder="Masukkan alamat lengkap" required>{{ old('alamat', $kapal->alamat) }}</textarea>
                        <div class="invalid-feedback"></div>
                    </div>
                    ...
                    <div class="mb-3">
                        <label for="kapasitas" class="form-label">Kapasitas (Orang / Ton) <span
                    ...
                    <div class="mb-3">
                        <label for="nomor_registrasi" class="form-label">Nomor Registrasi <span
                                class="text-danger">*</span></label>
                        <input type="text" name="nomor_registrasi" id="nomor_registrasi" class="form-control"
                            value="{{ old('nomor_registrasi', $kapal->nomor_registrasi) }}"
                    ...
                    <div class="mb-3">
                        ...
                        <div class="invalid-feedback"></div>
                        <img id="previewFoto" src="{{ $kapal->foto_kapal ? asset('storage/' . $kapal->foto_kapal) : '#' }}"
                            alt="Preview Foto"
                    ...
                    <div class="mb-3">
                        ...
                        <div class="invalid-feedback"></div>
                        <div id="previewDokumen" class="mt-2"
                            style="display: {{ $kapal->dokumen_kapal ? 'flex' : 'none' }};">
                            <i class="bi bi-file-earmark-text text-primary"></i>
                            <span id="dokumenFileName"
                                class="fw-semibold">{{ $kapal->dokumen_kapal ? basename($kapal->dokumen_kapal) : '' }}</span>
                        </div>
                    </div>
